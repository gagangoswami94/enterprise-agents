...
# Enterprise Agents (https://github.com/gagangoswami94/enterprise-agents).
#
...
#
# Full roster of specialized AI agents from Enterprise Agents.
...
main() {
  ...
  header "Enterprise Agents -- Converting agents to tool-specific formats"
  echo "  Repo:   $REPO_ROOT"
  echo "  Output: $OUT_DIR"
  echo "  Tool:   $tool"
  echo "  Date:   $TODAY"
